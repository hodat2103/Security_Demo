...
public class RSAUtil {
    ...
    public static String encryptRSA(String plainText) throws InvalidKeyException,GeneralSecurityException,Exception {
        try {
    ...
    public static String decryptRSA(String cipherText) throws IllegalArgumentException,InvalidKeyException,GeneralSecurityException,Exception {
        try {
            if(cipherText == null){
